...
export const Caption: React.FC<CaptionProps> = ({
    ...
    const fadeIn = interpolate(frame, [startFrame, startFrame + 8], [0, 1], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
    ...
    return (
          <div style={{ position: 'absolute', left: 40, right: 40, ...positionStyle, opacity, zIndex: 100, textAlign: 'center' }}>
                  <span style={{
                    ...
                    fontFamily: FONTS.body, fontSize: fontSizeMap[size],
                    fontWeight: FONT_WEIGHTS.semibold, lineHeight: 1.4,
                    padding: '12px 24px', borderRadius: 12, letterSpacing: '-0.01em',
          }}>
                    {text}
                  </span>span>
          </div>div>
